---
name: debugging-code
description: 'Hands-on interactive debugging: set breakpoints, step through execution, inspect live variables, and trace call stacks. Use when you need to debug a running program with a debugger, not just reason about it.'
risk: critical
