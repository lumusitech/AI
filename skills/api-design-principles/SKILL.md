...
description: "Design REST and GraphQL APIs from scratch: resource modeling, endpoints, verbs, status codes, naming, and API contracts. Use when creating a new API's design or interface."
risk: safe
source: community
